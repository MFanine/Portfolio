...
const Index = ({ stats, topRepos }: AppProps) => {
    return (
        ...
        >
            <h1 className="mt-36 font-bold text-4xl md:text-5xl mb-4">Hey, I'm Fanine Mouad 👋</h1>
            ...
            <div className="grid grid-cols-3  sm:grid-cols-4 rounded-md border-slate-800 hover:border-sky-400  border-x-2 border-y-2 p-2 font-light  mb-6">
                ...
                <TechItem icon={SiJava} text="Java" />
                <TechItem icon={SiPhp} text="Php" />
                <TechItem icon={SiC} text="langague C" />
                <TechItem icon={SiNodeJs} text="Node.js" />
                <TechItem icon={SiExpress} text="Express.js" />
                <TechItem icon={SiReact} text="React" />
                <TechItem icon={SiNextJs} text="Next.js" />
                <TechItem icon={SiMicrosoftsqlserver} text="SQL Server" />
                {/* <TechItem icon={SiGolang} text="Go" /> */}
                {/* <TechItem icon={SiNestjs} text="Nestjs" /> */}
                <TechItem icon={SiPostgresql} text="Postgres" />
                <TechItem icon={SiMongodb} text="MongoDB" />
                <TechItem icon={SiMysql} text="My Sql" />
                ...
                <TechItem icon={SiWordpress} text="Wordpress" />
                <TechItem icon={SiJquery} text="jQuery" />
